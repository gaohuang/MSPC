function [alfa, a, b] = mpm_linear(mX,mY,covX,covY,nu,rho_x,rho_y,gauss_assump,algoparam,tol,maxiter);
% mpm_linear - build a robust linear minimax probability machine (MPM) for binary classification
...
%
% [alfa, a, b] = mpm_linear(mX,mY,covX,covY,nu,rho_x,rho_y,gauss_assump,algoparam,tol,maxiter)
%
%
